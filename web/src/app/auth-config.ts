...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        'https://wickramtastydeals.b2clogin.com/wickramtastydeals.onmicrosoft.com/B2C_1_susi',
    },
    resetPassword: {
      authority:
        'https://wickramtastydeals.b2clogin.com/wickramtastydeals.onmicrosoft.com/B2C_1_password_reset',
    },
    editProfile: {
      authority:
        'https://wickramtastydeals.b2clogin.com/wickramtastydeals.onmicrosoft.com/B2C_1_profile_edit',
    },
  },
  authorityDomain: 'wickramtastydeals.b2clogin.com',
};

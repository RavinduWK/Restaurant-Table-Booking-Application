...
namespace RestaurantTableBookingApp.Service.Services
{
    public class EmailNotificationService : IEmailNotificationService
    {
        ...
        public EmailNotificationService(IConfiguration configuration, IRestaurantRepository restaurantRepository)
        {
        ...
        public async Task<Response> SendBookingEmailAsync(ReservationModel model, bool isReminderEmail = false)
        {
            ...
            var from = new EmailAddress(configuration["SendGrid:From"], "ReserveSpot");
